...
<section className=''>
  <MDBContainer className='text-center text-md-start mt-5 p-4'>
    <MDBRow className='mt-3'>
      ...
      <MDBCol md="2" lg="2" xl="2" className='mx-auto mb-4'>
        <h5 className='text-uppercase fw-bold mb-4'>Guides</h5>
        
      <p><Link to={'https://react.dev/'} style={{ textDecoration:'none'}}>React</Link></p>

      <p><Link to={'https://react-bootstrap.netlify.app/'} style={{ textDecoration:'none'}}>React Bootsrtap</Link></p>
       
      <p><Link to={'https://bootswatch.com/'} style={{ textDecoration:'none'}}>BootsWatch</Link></p>
